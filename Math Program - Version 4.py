...
# This is the displays the title of the GUI
    ...
    def difficulty_selection(self):
        ...
        difficulty_box = tk.Listbox(self.main_frame, font = ("Arial", 28, "bold"), bg = "white", fg = "black", relief = "solid", borderwidth = 1)

        difficulty_box.place(x = 320, y = 200, width = 250, height = 140)

        difficulty_box.insert(1, ">Easy\n")
        difficulty_box.insert(2, ">Medium\n")
        difficulty_box.insert(3, ">Hard\n")
        difficulty_box.select_set(0)
        difficulty_box.focus_set()

        button_confirm = tk.Button(self.main_frame, text = "Confirm", fg = "#000000", font = title_font, bg = "#87CEEB", relief = "solid", borderwidth = 1, command = self.math_quiz)
